  ...
  return (
    <aside className="w-60 shrink-0 h-screen sticky top-0 border-r border-border bg-surface-1 flex flex-col">
      ...
      <div className="px-5 py-4 border-t border-border">
        {/*
          The template a build came from is deliberately NOT shown here.

          It is build metadata, not something this business's staff have any use for, and
          naming another industry in the corner of someone's own CRM reads as a product
          that was borrowed rather than made. The provenance is not lost — it stays in the
          build's app.json, where the people who need it look.
        */}
        <PoweredByAraxys />
      </div>
    </aside>
